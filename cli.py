...
if (__name__ == '__main__'):
    ...
    parser.add_argument("-o", "--output", dest = "output", type = str, help = "An output xlsx file")
    ...
    if (args.file):
        ...
        for sheet_name in wb.sheetnames:
            config_list.append(Config(file = os.path.abspath(args.file.encode("utf-8").decode("utf-8")), sheet=sheet_name)) 
